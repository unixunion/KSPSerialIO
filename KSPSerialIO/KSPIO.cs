...
namespace KSPSerialIO
{
    ...
    public struct VesselData
    {
        ...
        public UInt16 TargetHeading;  //54
        public UInt16 ManeuverPitch;  //55 Direction of maneuver prograde
        ...
        public byte FarSOINumber;   //65  The SOI of the farthest patch. 0 if this is an uniterrupted orbit.
